	...
	<div class="panel-body">
		<form method="post" action="/employerAdd.do">
			<input type='hidden' name='csrfmiddlewaretoken'
				...
				name='csrfmiddlewaretoken' value='XFe2rTYl9WOpV8U6X5CfbIuOZOELJ97S' />
			<div id="div_id_aliasname" class="form-group required">
				...
				<div class="controls col-md-8 ">
					<input
						class="input-md form-control textInput required_entry_employer"
			...
			<div id="div_id_password1" class="form-group required">
				...
				<div class="controls col-md-8 ">
					<input
						class="input-md textinput textInput form-control required_entry_employer"
			...
			<div id="div_id_password2" class="form-group required">
				...
				<div class="controls col-md-8 ">
					<input
						class="input-md textinput textInput form-control required_entry_employer"
						id="id_password2" name="password2" style="margin-bottom: 10px"
						type="password" />
				</div>
			</div>
			...
			<div id="div_id_company" class="form-group required">
				<label for="id_company"
					class="control-label col-md-4  requiredField"> Company Name<span
					class="asteriskField">*</span>
				</label>
				<div class="controls col-md-8 ">
					<input
						class="input-md textinput textInput form-control required_entry_employer"
						id="id_company" name="company" style="margin-bottom: 10px"
						type="text" />
				</div>
			</div>
			...
			<div id="div_id_number" class="form-group required">
				...
				<div class="controls col-md-8 ">
					<input
						class="input-md textinput textInput form-control required_entry_employer"
						id="id_number" name="number" style="margin-bottom: 10px"
						type="text" />
				</div>
			</div>
			<div id="div_id_address" class="form-group required">
				...
				<div class="controls col-md-8 ">
					<input
						class="input-md textinput textInput form-control required_entry_employer"
						id="id_address" name="Address" style="margin-bottom: 10px"
						type="text" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="controls col-md-8 ">
					<input type="submit" name="Signup" value="Signup"
						class="btn btn-primary btn btn-info requiredSubmitEmployer"
						id="submit-id-signup" />
				</div>
			</div>
