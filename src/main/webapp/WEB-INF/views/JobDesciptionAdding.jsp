...
<title>AddingJobDesciption - ITJobsSG.com</title>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					...
					<div
						...
						<a id="signinlink" href="/accounts/login/">For Employers</a>
					</div>
				</div>
						...
						<form class="form-horizontal" method="post">
							...
							<div id="div_id_aliasname" class="form-group required">
								<label for="id_aliasname"
									class="control-label col-md-4  requiredField"> Alias
									Name<span class="asteriskField">*</span>
								</label>
								<div class="controls col-md-8 ">
									<input class="input-md  textinput textInput form-control"
										id="id_aliasname" maxlength="30" name="aliasname"
							...
							<div id="div_id_jobtitle" class="form-group required">
								<label for="id_jobtitle"
									class="control-label col-md-4  requiredField">Job Title<span class="asteriskField">*</span>
								</label>
								<div class="controls col-md-8 ">
									<input class="input-md textinput textInput form-control"
										id="id_jobtitle" name="jobtitlw" placeholder="Enter the Job Title"
										style="margin-bottom: 10px" type="text" />
								</div>
							</div>
							...
							<div id="div_id_company" class="form-group required">
								<label for="id_jobdesc"
									class="control-label col-md-10  requiredField"> Job Description<span class="asteriskField">*</span>
								</label>
								<div class="controls row-lg-12 col-lg-12">
									<textarea class="input-md textinput textInput form-control"
										id="id_jobdesc" name="jobdesc" placeholder="Enter the Job Description"
							...
							<div id="div_id_company" class="form-group required">
								<label for="id_jobskills"
									class="control-label col-md-4  requiredField"> Job Skills<span class="asteriskField">*</span>
								</label>
							  <div class="controls col-lg-12 row-lg-12">
									<textarea class="input-md textinput textInput form-control"
										id="id_jobskills" name="jobskills" placeholder="Enter the Job Skills with comma seperated"
